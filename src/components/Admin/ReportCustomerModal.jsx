...
const ReportCustomerModal = ({ username, onSubmit, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-[1000]">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full relative text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Report Customer</h2>
                <p className="text-gray-500 dark:text-gray-400 mb-6">You are reporting {username}. Please provide a reason below.</p>

                <textarea
                    value={reason}
                    onChange={(e) => setReason(e.target.value)}
                    placeholder="Describe the issue (e.g., payment dispute, behavior)..."
