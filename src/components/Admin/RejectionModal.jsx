...
const RejectionModal = ({ username, onSubmit, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-[1000]">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full relative text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Reject Application</h2>
                <p className="text-gray-500 dark:text-gray-400 mb-6">You are rejecting the application for {username}. Please provide a reason below.</p>

                <textarea
                    value={reason}
                    onChange={(e) => setReason(e.target.value)}
                    placeholder="Enter reason for rejection..."
                    className="w-full border border-gray-300 rounded-md p-3 min-h-[120px] focus:ring-2 focus:ring-red-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                />
...
export default RejectionModal; // This line is essential